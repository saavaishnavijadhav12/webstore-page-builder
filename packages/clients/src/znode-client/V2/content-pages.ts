 ...
 * @return Success(Indicates that the request is successfully executed and the response body return the data in ContentPageResponse model.)
 */

export async function ContentPages_contentPagesByPageCode(
  pageCode: string,
  userID: number,
  storeCode: string | undefined,
  localeCode: string | undefined,
  cacheInvalidator?: FilterTuple[] | undefined
): Promise<MultifrontTypes.ContentPageResponse> {
  ...
  let url_ = baseUrl + "v2/content-pages/{pageCode}";
  ...
  if (pageCode === undefined || pageCode === null) throw new Error("The parameter 'pageCode' must be defined.");
  ...
  return fetch(url_, options_).then((_response: Response) => {
    return ContentPages_processContentPagesByPageCode(_response);
  });
}

function ContentPages_processContentPagesByPageCode(response: Response): Promise<MultifrontTypes.ContentPageResponse> {
